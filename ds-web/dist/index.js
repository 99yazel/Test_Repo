...
var _excluded = ["label", "width", "size", "disabled", "onClick", "primary", "icon"];
...
var Button = function Button(_ref) {
  ...
  var theme = useTheme();
  return jsx("button", {
    css: [ButtonWrapper(theme), primary && primaryStyle(theme), disabled && disabledStyle(theme), {
      width: width
    }]
  }, jsx("span", {
    css: [iconWrapStyle]
...
var iconWrapStyle = css(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  position: absolute;\n  left: 1rem;\n"])));

var ButtonWrapper = function ButtonWrapper(theme) {
  return css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  /* round tab */\n  border: 0;\n  width: 335px;\n  height: 44px;\n\n  /* Login btn shadow */\n  box-shadow: 0px 0px 3px rgba(0, 0, 0, 0.084), 0px 2px 3px rgba(0, 0, 0, 0.168);\n  border-radius: 6px;\n\n  position: relative;\n  display: flex;\n  flex-direction: row;\n  justify-content: center;\n  align-items: center;\n  font-size: 15px;\n  background: ", ";\n  &:hover {\n    background: ", ";\n  }\n  &:focus {\n    background: ", ";\n  }\n"])), theme.colors.button_background, theme.colors.button_background_hover, theme.colors.button_background_focus);
};

var primaryStyle = function primaryStyle(theme) {
  return css(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n  color: ", ";\n  background: ", ";\n  &:hover {\n    background: ", ";\n  }\n  &:focus {\n    background: ", ";\n  }\n"])), theme.colors.text_on_primary, theme.colors.primary, theme.colors.primary_hover, theme.colors.primary_selected);
};

var disabledStyle = function disabledStyle(theme) {
  return css(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n  background: ", ";\n  &:hover {\n    background: ", ";\n  }\n  &:focus {\n    background: ", ";\n  }\n"])), theme.colors.disabled_background, theme.colors.disabled_background, theme.colors.disabled_background);
};
